    ...
    return (
        <div className='my-12 py-12'>
            ...
            <div className='grid mt-8 grid-cols-1 md:grid-cols-3 gap-4 lg:grid-cols-6'>
               ...
               <img src="/assets/images/core feature/Group 71.svg" alt="chooseUs" className='mx-auto' />
               ...
               <img src="/assets/images/core feature/Group 38729.svg" alt="chooseUs" className='mx-auto' />
                <h1 className='font-bold'>Timely Delivery</h1>
               </div>
               <div className='border space-y-3 text-center p-4 shadow-lg rounded-md'>
               <img src="/assets/images/core feature/Group.svg" alt="chooseUs" className='mx-auto' />
               <h1 className='font-bold'>24/7 Support</h1>
               </div>
               <div className='border space-y-3 text-center p-4 shadow-lg rounded-md'>
               <img src="/assets/images/core feature/Wrench.svg" alt="chooseUs" className='mx-auto' />
               <h1 className='font-bold'>Best Equipment</h1>
               </div>
               <div className='border text-center space-y-3 p-4 shadow-lg rounded-md'>
               <img src="/assets/images/core feature/Group 38730.svg" alt="chooseUs" className='mx-auto'/>
               <h1 className='font-bold'>100% Guranty</h1>
               </div>
               <div className='border text-center space-y-3 p-4 shadow-lg rounded-md'>
               <img src="/assets/images/core feature/Group 38731.svg" alt="chooseUs" className='mx-auto' />
               <h1 className='font-bold'>Timely Delivery</h1>
               </div>
            </div>
        </div>
